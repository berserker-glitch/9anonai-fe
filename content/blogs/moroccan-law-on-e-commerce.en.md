...
1.  **Scope of Application:** The law applies to production, distribution, and service activities, including those performed by public entities acting as economic operators.
2.  **Transparency and Fairness:** For entities operating in the capital markets, **Law No. 43.12** (governing the Moroccan Capital Market Authority - AMMC) emphasizes the principles of equity, transparency, and the priority of the client's interests.
3.  **Prohibition of Anti-competitive Practices:** Agreements that aim to restrict competition or abuse a dominant market position are strictly prohibited to ensure a healthy digital economy.
