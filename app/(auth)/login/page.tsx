...
export default function LoginPage() {
    ...
    const redirect = (u: { role?: string; isOnboarded?: boolean }) => {
        if (u.role === "superadmin") router.push("/admin");
        else if (!u.isOnboarded) router.push("/setup");
            ...
            <div className="relative z-10 w-full max-w-[400px] mx-auto px-5 py-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button
                        ...
                        onClick={() => googleLogin()}
                        disabled={isLoading}
                        className="w-full flex items-center justify-center gap-3 py-3.5 rounded-xl border border-border bg-background text-foreground text-[15px] font-medium hover:bg-muted/50 disabled:opacity-50 transition-colors"
                    >
